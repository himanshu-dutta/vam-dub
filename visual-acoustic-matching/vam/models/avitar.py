...
def load_dereverberator(device, use_vida=False):
    if use_vida:
        ...
        pretrained_weights = '/home/checkpoints/vam/pretrained-models/dereverb/vida.pth'
        ...
        from vam.trainer import parser
        pretrained_weights = '/home/checkpoints/vam/pretrained-models/dereverb/avitar.pth'
        state_dict = torch.load(pretrained_weights, map_location='cpu')
        default_args = parser.parse_args("")
